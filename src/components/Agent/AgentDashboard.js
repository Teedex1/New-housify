...
function AgentDashboard() {
  return (
    <div className="Agent">
      <Header />
      <AgentHeroBanner
        header="Tunde Ogunmodede"
        text="Expert dealer in Residential Homes and Luxury apartments. Licensed in Nigeria. Trusted by experts and companies with 4.5 rating in Trustpilot."
